...
class ProductController extends Controller
{
    ...
    {
        $activeSeller = User::where('status','active')->where('role','seller')->latest()->get();
        $brands = Brand::latest()->get();
        $categories = Category::latest()->get();
        return view('backend.product.add_product', compact('brands','categories','activeSeller'));
    }
    // End Method
    ...
    public function edit_product($id)
    {
        ...
        return view('backend.product.edit_product',compact('brands','categories','activeSeller','product','subcategories','multipleImages'));
    }
    // End Method
