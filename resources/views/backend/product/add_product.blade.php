                          ...
                          <div class="row g-3">
                            <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                ...
                                <input required type="text" class="form-control" name="discount_price" id="inputPrice" placeholder="00.00">
                              </div>
                              <div class="col-md-6">
                              ...
                              <div class="col-12">
                                ...
                                <select  name="subcategory_id" class="form-control" id="inputCollection">
                                    <option></option>
                                  </select>
                              </div>
                              <div class="col-12">
                                ...
                                <div class="row g-3">
                                  <div class="col-md-6">
                                    <div class="form-check">
                                      <input class="form-check-input" name="hot_deals" type="checkbox" value="1" id="flexCheckChecked" checked="">
                                      <label class="form-check-label" for="flexCheckChecked">Hot Deals</label>
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-check">
                                      <input class="form-check-input" name="featured" type="checkbox" value="1" id="flexCheckChecked" checked="">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-check">
                                      <input class="form-check-input" name="special_deals" type="checkbox" value="1" id="flexCheckChecked" checked="">
                                      <label class="form-check-label" for="flexCheckChecked">Special Deals</label>
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-check">
                                      <input class="form-check-input" name="special_offer" type="checkbox" value="1" id="flexCheckChecked" checked="">
