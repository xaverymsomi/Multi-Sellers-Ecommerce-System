...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Seller Order Details</h1>
        </div>
                    ...
                    <div class="card-body">
                        <table class="table" style="background: #add">
                            ...
                            <tr>
                                <th>Action</th>
                                @if ($order->order_status == 'pending')
                                <td><a href="{{ route('seller.confirmed.order',$order->id) }}" class="btn btn-block btn-danger">Confirm Order</a></td>
                                @elseif ($order->order_status == 'confirm')
                                
                                <td><a href="{{ route('seller.processed.order',$order->id) }}" class="btn btn-block btn-warning">Processing Order</a></td>
                                @elseif ($order->order_status == 'processing')
                                <td><a href="{{ route('seller.delivered.order',$order->id) }}" class="btn btn-block btn-info">Delivered Order</a></td>
                                @elseif ($order->order_status == 'delivered')
