    ...
    <div class="page-content">
        <div class="card">
            <div class="card-body p-4">
                ...
                <hr>
                <form action="{{ route('seller.update_product') }}" method="post" enctype="multipart/form-data">
                  @csrf
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <hr>
<div class="card">
    <form action="{{ route('seller.update_product_image') }}" method="post" enctype="multipart/form-data">
    @csrf
<input type="hidden" name="id" value="{{ $product->id }}">
...
<div class="card">
    <div class="card-body">
        <table class="table mb-0 table-striped">
            ...
            <tbody>
                <form action="{{ route('seller.update_multi_image') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a type="button" class="btn text-danger btn-sm btn-sm shadow-sm" href="{{ route('seller.destroy_multi_image', $multipleImage->id) }}" id="delete">
                                Delete
                            </a>
                        </td>
                    </tr>
