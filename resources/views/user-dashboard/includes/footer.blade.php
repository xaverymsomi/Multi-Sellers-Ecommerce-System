...
<footer id="footer" class="footer color-bg">
              ...
              <ul class="toggle-footer" style="">
                <li class="media">
                  ...
                  <div class="media-body">
                    <p>{{ $setting->company_addres }}</p>
                  </div>
                </li>
                <li class="media">
                  <div class="pull-left"> <span class="icon fa-stack fa-lg"> <i class="fa fa-mobile fa-stack-1x fa-inverse"></i> </span> </div>
                  <div class="media-body">
                    <p>{{ $setting->contacts }}</p>
                  </div>
                </li>
                <li class="media">
    ...
    <div class="copyright-bar">
      <div class="container">
        <div class="col-xs-6 col-sm-4 no-padding social">
          <ul class="link">
            <li class="fb pull-left"><a target="_blank" rel="nofollow" href="{{ $setting->facebook }}" title="Facebook"></a></li>
            <li class="instagram pull-left"><a target="_blank" rel="nofollow" href="{{ $setting->instagram }}" title="PInterest"></a></li>
        ...
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
              <span> &copy; {{ $setting->copyright }} <?php echo date('Y') ?></span>
          </div>
      </div>
        </div>
      </div>
